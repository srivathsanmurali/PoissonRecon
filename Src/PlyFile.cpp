  ...
  ******************************************************************************/
	  ...
	  )
  {
	  ...
	  case PLY_INT_32:
		  ...
		  {
			  fprintf(stderr, "PLY ERROR int: fprintf() failed -- aborting.\n");
			  exit(1);
		  }
		  break;
	  case PLY_UCHAR:
	  ...
	  case PLY_UINT_32:
		  ...
		  {
			  fprintf(stderr, "PLY ERROR uint: fprintf() failed -- aborting.\n");
			  exit(1);
		  }
		  break;
	  case PLY_FLOAT:
	  ...
	  if (fprintf (fp, "%g ", double_val) <= 0)
		  {
			  fprintf(stderr, "PLY ERROR float: fprintf() failed -- aborting.\n");
			  exit(1);
		  }
		  break;
	  default:
  ...
  ******************************************************************************/
	  ...
	  )
  {
	  ...
	  if (fread (ptr, ply_type_size[type], 1, fp) != 1)
	  {
		  ...
		  fprintf(stderr, "Type = %u, Size = %u.\n", type, ply_type_size[type]);
		  fprintf(stderr, "Type = %u, Size = %u.\n", PLY_FLOAT_32, ply_type_size[PLY_FLOAT_32]);
      for(int i = 0; i <= 16; i++ ){
		    fprintf(stderr, "Type = %u, Size = %u.\n", i, ply_type_size[i]);
      }
		  exit(1);
